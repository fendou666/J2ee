...
public class StudentServiceImp implements IStudentService {
	...
	public List<StudentInfo> getStudentByName(String name) {
		...
		HashMap mp = studentDAO.getStudentByName(name);
		if(mp!=null){
	...
	@Override
	public List<StudentInfo> getStudentByName(String name, SqlDataPage stuPage) {
		List<StudentInfo> stuList = null;
		HashMap mp = studentDAO.getStudentByName(name, stuPage);
		if(mp!=null){
			stuList = (List<StudentInfo>)mp.get("stuList");
		}
		return stuList;
