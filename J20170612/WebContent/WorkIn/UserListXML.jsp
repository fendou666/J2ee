				...
				function(data){
					...
					$(data).find("student").each(function(){
						...
						if(student.indexOf("#")!=-1){
							stuInfo = student.split("#");
							htmlData += "<tr>"
							htmlData += "<td>" + stuInfo[0]  +"</td>";
							htmlData += "<td>" + stuInfo[1]  +"</td>";
							htmlData += "<td>" + stuInfo[2]  +"</td>";
							htmlData += "<td>" + stuInfo[3]  +"</td>";
							htmlData += "<td>" + stuInfo[4]  +"</td>";
							htmlData += "<td>" + stuInfo[5]  +"</td>";
							htmlData += "<td><a href=\"<%=request.getContextPath() %>/OracleOperationServlet?action=seachById&id="+ stuInfo[0] +"\">修改</a></td>";
							htmlData += "<td><a href=\"<%=request.getContextPath() %>/OracleOperationServlet?action=del&delNum="+ stuInfo[0] +"\">删除</a></td>";
							htmlData += "</tr>";
						}else{
							console.log("这样子indexOf出错");
							htmlData += "<tr clospan=\"7\">";
							htmlData += "<td>没有获取到数据</td>";
							htmlData += "</tr>";
						}
					})
					$("#tb").html(htmlData);
