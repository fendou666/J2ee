...
<html>
	...
	<body>
		...
		<%
			...
			msgList.add(new MsgListNeed(5, 170000005, "肖梦娜", "05.jpg",
					"标题1", "天干物燥，小心火烛，心情烦躁，生人勿近!", 
					new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())
					));
			msgList.add(new MsgListNeed(6, 170000006, "赵博", "06.jpg",
					"标题1", "世界上唯一不用努力就能得到的只有年龄?", 
					new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())
					));
			msgList.add(new MsgListNeed(7, 170000007, "老师1", "07.jpg",
					"标题1", "对于你，我始终只能以陌生人的身份去怀念", 
					new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())
					));
			msgList.add(new MsgListNeed(8, 170000008, "老师2", "08.jpg",
					"标题1", "对于你，我始终只能以陌生人的身份去怀念", 
					new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())
					));
			msgList.add(new MsgListNeed(9, 170000009, "老师3", "09.jpg",
					"标题1", "对于你，我始终只能以陌生人的身份去怀念", 
					new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())
					));
			msgList.add(new MsgListNeed(10, 170000010, "老师4", "10.jpg",
					"标题1", "对于你，我始终只能以陌生人的身份去怀念", 
					new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())
					));
							...
							<ul style="list-style-type: none; ">
								<li  onmouseleave="testHide(ls.$('hide_${iid.index +1}'))" onmouseover="testShow(ls.$('hide_${iid.index +1}'))">
									...
									<ul  class="hide" id="hide_${iid.index +1}" style="display: none;text-align:center;list-style-type: none; margin-left: -60px;border: 1px solid;">
										<c:if test="${sessionScope.u.id ==  tmp.eecId}">
