...
<script type="text/javascript" >
	...
	function checkDataAddErr(id, errInfoId){
		...
		if(id=="#classId" || id=="#eecId" || id=="#eecName" || id=="#age" || id=="#roleId"){
		...
		<form id="regFM" action="<%=request.getContextPath() %>/AdminServlet?action=insertData" method="post">
			<table>
				...
				<tr>
					<td>班级</td>
					<td>
						<input type="text" name="classId" id="eecId"
				...
				<tr>
					...
					<td>
						<input type="text" name="roleName" id="roleName" 
							onfocusin="initCheckInfo('#roleNameCheckInfo')"
							onfocusout="checkDataAddErr('#roleName', '#roleNameCheckInfo')"
						 />
						<span name="roleNameCheckInfo" id="roleNameCheckInfo" style="color:red">*</span>
					</td>
				</tr>
				<tr>
